...
import { useSubjectAddFormController } from "./SubjectAddForm.controller";
 ...
 */
export const SubjectAddForm = (props: { onSubmit?: () => void }) => {
    const { formatMessage } = useIntl();
    const { state, actions, computed } = useSubjectAddFormController(props.onSubmit); // Use the controller.
        ...
        <Stack spacing={4} style={{ width: "100%" }}>
            <ContentCard >
                <div style={{ textAlign: "center", marginBottom: "20px", fontSize: "24px", fontWeight: "bold", color: "#333" }}>
                    {formatMessage({ id: "globals.addSubjectTitle" })}
                </div>
