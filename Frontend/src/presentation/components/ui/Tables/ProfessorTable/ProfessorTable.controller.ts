...
import { useProfessorApi } from "@infrastructure/apis/api-management";
 ...
 */
export const useProfessorTableController = () => {
    const { getProfessors: { key: queryKey, query }, deleteProfessor: { key: deleteProfessorKey, mutation: deleteProfessor } } = useProfessorApi(); // Use the API hook.
