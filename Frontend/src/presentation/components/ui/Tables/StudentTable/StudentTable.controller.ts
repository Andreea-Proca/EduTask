...
import { useStudentApi } from "@infrastructure/apis/api-management";
 ...
 */
export const useStudentTableController = () => {
    const { getStudents: { key: queryKey, query }, deleteStudent: { key: deleteStudentKey, mutation: deleteStudent } } = useStudentApi(); // Use the API hook.
